...
// Datos estáticos de Concejos Municipales, ahora con clave "2024" para 2024–2028
...
// Convierte clave de año en su rango textual
...
// ─────────────────────────────────────────────────────────────────────
// Componente para Alcaldes 2016–2021 desde Google Sheets
...
// ─────────────────────────────────────────────────────────────────────
// Componente para Concejales 2016–2021 desde Google Sheets
...
export default function Home() {
  ...
  const [selectedAnio, setSelectedAnio] = useState("2016");
  ...
  // Datos seleccionados de Concejos Municipales
    ...
    >
      ...
      {selectedSection === "Elecciones" && (
        <div className="w-full max-w-5xl space-y-6">
          ...
          {/* …el resto de tu sección “Elecciones” permanece igual… */}
        </div>
      )}
